...
const verificationData = [
  ...
  { date: '2025-06-01', verifications: 310 },
];

const statusData = [
  { name: 'Issued', value: 1248 },
    ...
    <section className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
      <Card>
        ...
        <CardContent>
          <div style={{ width: '100%', height: 200 }}>
            <ResponsiveContainer>
              <AreaChart data={issuedData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                <defs>
      ...
      <Card>
        ...
        <CardContent>
          <div style={{ width: '100%', height: 200 }}>
            <ResponsiveContainer>
              <BarChart data={verificationData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                <XAxis dataKey="date" tick={{ fontSize: 12 }} />
                <YAxis />
                <CartesianGrid strokeDasharray="3 3" />
                <Tooltip />
      ...
      <Card>
        ...
        <CardContent>
          <div style={{ width: '100%', height: 200 }} className="flex items-center justify-center">
            <ResponsiveContainer>
              <PieChart>
                <Pie data={statusData} dataKey="value" nameKey="name" innerRadius={50} outerRadius={80} fill="#8884d8" label>
